<template>
	<div class="riskText">
		<p style="color:#ff5722;font-size:0.8rem;margin:1rem 0">恭喜您实名绑卡成功！请完成风险评测</p>
		...
		<button class="btn_default btn" @click="goRisk()">风险评测</button>
	</div>
...
.btn{position:fixed;bottom:0;border-radius:0;left:0}
</style>